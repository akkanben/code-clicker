...
public class InitializeStoreItems {
    ...
    public static void hardCodedStoreItems(Game game) {
        ...
        game.getGeneratorList().add(new Generator("Firewall", R.drawable.data_flow_graph_filter, "Firewall Description", 60, 1.15, 20));
        game.getGeneratorList().add(new Generator("Database", R.drawable.databases, "Database Description", 720, 1.14, 90));
        game.getGeneratorList().add(new Generator("Vending Machine", R.drawable.vending_machine_retro,"Vending Machine Description", 8640, 1.13, 360));
        Upgrade higherRes = new Upgrade("Higher Resolution", R.drawable.monitor_1, "Higher Resolution Description", 1000, GENERATOR_EFFICIENCY);
        Upgrade moreBricks = new Upgrade("More Bricks", R.drawable.cash_funding_loot_money_1, "More Bricks Description", 5000, GENERATOR_EFFICIENCY);
